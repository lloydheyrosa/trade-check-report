...
public class CustomerSubAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null) {
            ...
            holder.tvwPostingDatetime = (TextView) convertView.findViewById(R.id.tvwPostingDatetime);
        ...
        holder.tvwAuditName.setText(arrCustomerStores.get(position).auditName);
