...
public class OsaReportActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.osa_report_activity);
        ...
        AuditAdapter dataAdapter = new AuditAdapter(OsaReportActivity.this, android.R.layout.simple_dropdown_item_1line, General.arraylistAudits);
    ...
    private class CheckInternet extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPreExecute() {
            progressDialog = ProgressDialog.show(OsaReportActivity.this, "", "Checking internet connection.");
        }
        ...
        protected void onPostExecute(Boolean bResult) {
            ...
            if(!bResult) {
                Toast.makeText(OsaReportActivity.this, errmsg, Toast.LENGTH_SHORT).show();
                return;
            }
    ...
    private class FetchOsaReportTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(OsaReportActivity.this, "", "Fetching OSA Report per SKU. Please wait.", false);
        }
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                ...
                URL url = new URL(General.URL_REPORT_OSA + "/" + selectedAuditID + "/user/" + General.usercode);
        ...
        protected void onPostExecute(Boolean bResult) {
            progressDialog.dismiss();
            if(!bResult) {
                Toast.makeText(OsaReportActivity.this, errMsg, Toast.LENGTH_LONG).show();
                return;
            }
