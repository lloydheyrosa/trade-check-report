...
import com.android.pplusaudit2.Math.cfg.StringConfiguration;
 ...
 */
public class Pplus_Questions extends AppCompatActivity {
    ...
    ArrayList<View> arrChildRequired;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pplus_questions);
        ...
        arrChildRequired = new ArrayList<View>();
        ...
        btnSaveSurvey.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final AlertDialog dialogSave = new AlertDialog.Builder(Pplus_Questions.this).create();
        ...
        while (!cursorQuestions.isAfterLast()) {
                ...
                switch (formtypeid) {
                    ...
                    case "1": // LABEL
                        layoutrow = (LinearLayout) LayoutInflater.from(Pplus_Questions.this).inflate(R.layout.question_1_label, null);
                    ...
                    case "2": // IMAGE CAPTURE
                        layoutrow = (LinearLayout) LayoutInflater.from(Pplus_Questions.this).inflate(R.layout.question_2_imagecapture, null);
                    ...
                    case "3": // NUMERIC
                        layoutrow = (LinearLayout) LayoutInflater.from(Pplus_Questions.this).inflate(R.layout.question_3_numeric, null);
                    ...
                    case "4": // SINGLE LINE TEXT
                        layoutrow = (LinearLayout) LayoutInflater.from(Pplus_Questions.this).inflate(R.layout.question_4_singlelinetext, null);
                    ...
                    case "5": // MULTI LINE TEXT
                        layoutrow = (LinearLayout) LayoutInflater.from(Pplus_Questions.this).inflate(R.layout.question_5_multilinetext, null);
                    ...
                    case "6": // SIGNATURE CAPTURE
                        layoutrow = (LinearLayout) LayoutInflater.from(Pplus_Questions.this).inflate(R.layout.question_6_signature, null);
                        ...
                        btnAddsign.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                Intent intentSignature = new Intent(Pplus_Questions.this, Pplus_Questions_signaturepad.class);
                    ...
                    case "7": // DATE
                        layoutrow = (LinearLayout) LayoutInflater.from(Pplus_Questions.this).inflate(R.layout.question_7_date, null);
                        ...
                        btnSetDate.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                DatePickerDialog dialog = new DatePickerDialog(Pplus_Questions.this, new DatePickerDialog.OnDateSetListener() {
                                    @Override
                    ...
                    case "8": // TIME
                        layoutrow = (LinearLayout) LayoutInflater.from(Pplus_Questions.this).inflate(R.layout.question_8_time, null);
                        ...
                        btnSetTime.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                TimePickerDialog timeDialog = new TimePickerDialog(Pplus_Questions.this, new TimePickerDialog.OnTimeSetListener() {
                                    @Override
                    ...
                    case "9": // MULTI ITEM SELECT
                        layoutrow = (LinearLayout) LayoutInflater.from(Pplus_Questions.this).inflate(R.layout.question_9_multiitem, null);
...
/*                        ImageView imgBrand = (ImageView) layoutrow.findViewById(R.id.imgBrandPicture);
                    ...
                    case "10": // SINGLE ITEM SELECT
                        layoutrow = (LinearLayout) LayoutInflater.from(Pplus_Questions.this).inflate(R.layout.question_10_singleitem, null);
                    ...
                    case "11": // COMPUTATIONAL
                        layoutrow = (LinearLayout) LayoutInflater.from(Pplus_Questions.this).inflate(R.layout.question_11_computational, null);
                        ...
                        if(cursFormula.getCount() > 0) {
                            ...
                            for (int i = 0; i < aFormids.length; i++) {
                                ...
                                LinearLayout lnrComp = (LinearLayout) LayoutInflater.from(Pplus_Questions.this).inflate(R.layout.question_11_computational_formula, null);
                    ...
                    case "12": // CONDITIONALS
                        layoutrow = (LinearLayout) LayoutInflater.from(Pplus_Questions.this).inflate(R.layout.question_12_conditional, null);
                        //conditionalAnswers = "";
                    ...
                    case "13": // LABEL HEADER
                        layoutrow = (LinearLayout) LayoutInflater.from(Pplus_Questions.this).inflate(R.layout.question_13_header, null);
...
/*        if(bmBrand != null) {
    ...
    private boolean CheckRequiredQuestions() {
        ...
        if(arrChildRequired.size() > 0) {
            for (View requiredView : arrChildRequired) {
                String strViewTag = String.valueOf(requiredView.getTag());
    ...
    private void CreateConditionalSurveyForms(final int condQuestionid, final String strFormtypeid, String strCondFormid, String strPrompt, String strExpAns, int nCondRequired, int nExempt, final String conditionAnswer, int isParentAnswered, int tblID) {
        ...
        switch (strFormtypeid) {
            ...
            case "2": // IMAGE CAPTURE
                ...
                if(nCondRequired == 1) arrChildRequired.add(tvwImageCapture);
            ...
            case "3": // NUMERIC
                ...
                if(nCondRequired == 1) arrChildRequired.add(txtNumeric);
            ...
            case "4": // SINGLE LINE TEXT
                ...
                if(nCondRequired == 1) arrChildRequired.add(txtSingleLine);
            ...
            case "5": // MULTI LINE TEXT
                ...
                if(nCondRequired == 1) arrChildRequired.add(txtMultiLine);
            ...
            case "6": // SIGNATURE CAPTURE
                ...
                if(nCondRequired == 1) arrChildRequired.add(tvwSign);
...
/*                if(isAnswered == 1) {
            ...
            case "7": // DATE
                ...
                if(nCondRequired == 1) arrChildRequired.add(txtDate);
                ...
                btnSetDate.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        DatePickerDialog dialog =
                                new DatePickerDialog(Pplus_Questions.this, new DatePickerDialog.OnDateSetListener() {
                                    @Override
                                    public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                                        String strdate = String.valueOf(monthOfYear+1) + "/" + String.valueOf(dayOfMonth) + "/" + String.valueOf(year);
                                        txtDate.setText(strdate);
            ...
            case "8": // TIME
                ...
                if(nCondRequired == 1) arrChildRequired.add(txtTime);
            ...
            case "9": // MULTI ITEM SELECT
                ...
                if(nCondRequired == 1) arrChildRequired.add(tvwMultiItem);
            ...
            case "10": // SINGLE ITEM SELECT
                ...
                if(nCondRequired == 1) arrChildRequired.add(tvwSingleItem);
    ...
    public class SaveSurvey extends AsyncTask<Void, Void, String> {
        ...
        protected void onPreExecute() {
            saveProgress = ProgressDialog.show(Pplus_Questions.this, "", "Saving answers. Please wait.");
        }
...
/*                        String[] aFields = {
                        ...
                        String[] aValues = {
                                "1",
                                answer,
                                String.valueOf(questionInitStatus),
                                String.valueOf(questionInitStatus),
                                storequestionid,
                        };*/
                        ...
                        //sqlLibrary.UpdateRecord(SQLiteDB.TABLE_STOREQUESTION, SQLiteDB.COLUMN_STOREQUESTION_id, storequestionid, aFields, aValues);
                    }
                    else {
                        sqlLibrary.ExecSQLWrite("UPDATE " + SQLiteDB.TABLE_STOREQUESTION
...
/*                        String[] aFields = {
                        ...
                        String[] whereValue = {
                                storeCategoryGroupID,
                                String.valueOf(qid)
                        };

                        sqlLibrary.UpdateRecord(SQLiteDB.TABLE_STOREQUESTION, whereField, whereValue, aFields, aValues);*/
                    }
                }
/*            }
            else return "No Answers found.";*/
        ...
        protected void onPostExecute(String strReturn) {
            ...
            saveProgress.dismiss();
            AlertDialog dl = new AlertDialog.Builder(Pplus_Questions.this).create();
            dl.setTitle("Saved");
...
/*        if(nCorrectCategory >= nGradeMatrix) {
    ...
    private void UpdateStoreCategory() {
        ...
        if(nGrpCorrectAns == nGrpTotalAns) status = 1;
