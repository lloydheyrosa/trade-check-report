 ...
 */
public class Pplus_GroupAdapter extends BaseAdapter {

    private Context mContext;
    private List<Pplus_GroupClass> lstGroup = null;
    private ArrayList<Pplus_GroupClass> arrGrouplist;
    private Typeface menufontIcon;

    public Pplus_GroupAdapter(Context ctx, ArrayList<Pplus_GroupClass> arrList)
    {
        this.mContext = ctx;
        lstGroup = arrList;
        arrGrouplist = new ArrayList<Pplus_GroupClass>();
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        if(view == null) {
            ...
            view = inflater.inflate(R.layout.pplus_layout_group_row, parent, false);
