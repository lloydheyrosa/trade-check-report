 ...
 */
public class Pplus_ActivityClass {
    ...
    public Pplus_ActivityClass(int id, int tempcatid, String activityName, String categTempid, String categStatus, General.SCORE_STATUS categScoreStatus) {
        this.activityID = id;
